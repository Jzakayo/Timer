...
Mercury = Body(0.330e24, -57.9e9, 0, 0, 47890, 3, 0.5, 0.6, 0.3)
Venus = Body(4.87e24, -108.2e9, 0, 0, 35040, 6, 0.6, 0, 0)
earth = Body(5.9736e24, -149.6e9, 0, 0, 29790, 8, 0, 0, 1)  # blue earth
Mars = Body(0.642e24, -227.9e9, 0, 0, 24140, 7, 1, 0, 1)
